...
<div class="admin-surface rounded-xl admin-fade-up p-6">
    ...
    <div class="space-y-3">
        ...
        <div class="rounded-lg border p-4 flex justify-between items-center gap-4">
            <div>
                ...
                <div class="text-sm text-gray-500">{{ optional($application->updated_at)->format('M d, Y h:i A') }}</div>
            </div>
